...
class HistoryFrom(forms.Form):
    title = forms.CharField(error_messages={'required': '请输入回忆标题'})
    content = forms.CharField(error_messages={'required': '请输入回忆内容'})
